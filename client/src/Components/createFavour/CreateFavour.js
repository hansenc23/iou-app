...
const CreateFavour = () => {
  ...
  const [storedType, setStoredType] = useState('Bought');
        ...
        <div className='createFavour_content'>
          ...
          <div className='createFavour_form'>
            ...
            <div className='createFavour_second_line'>
              ...
              <InlineText className='who_field' text={storedUser} onSetText={(text) => setStoredUser(text)} />
            </div>
          ...
          <div className='btn_container'>
            <button className='confirm_favour_btn'>
              {' '}
              <span>Confirm</span>
            </button>
            <button
